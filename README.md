...
- 🪝 自定义React hooks：围绕 wagmi 的 React 钩子集合，通过 typescript 自动补全简化与智能合约的交互
- 🧱 Web3组件库：通用 web3 组件集合，可快速构建您的前端
...
3. 部署具体任务类型合约（如FixedPaymentTask、BiddingTask、MilestonePaymentTask）
